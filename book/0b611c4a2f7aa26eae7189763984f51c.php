<!DOCTYPE html>
    ...
    echo "  <header>
            ...
            <br>
            <br>"; ?> <div>
                    <img style="width: 236px; height: 363px; float: left;" src="../data/image/0b611c4a2f7aa26eae7189763984f51c.jpg">    <p style="background: #ddd;display: inline-block;padding: 10px; margin: 10px; " id="scrap">momomommo</p>  <span style="background: #ddd;padding: 10px; margin: 10px; position: ">mybook </span>       </div>
                    </div>
                </html>